...
def load_tokenizer(
    ...
    if not convert_to_fast_tokenizer or isinstance(tokenizer, PreTrainedTokenizer):#PreTrainedTokenizerFast):
        return tokenizer
    return PreTrainedTokenizer(__slow_tokenizer=tokenizer)  # Dirty, but worth it
